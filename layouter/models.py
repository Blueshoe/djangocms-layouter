...
class ContainerPlugin(CMSPlugin):
    ...
    equal_height = models.BooleanField(verbose_name=_('Align Content Height'),
        help_text=_('Align height of all columns in this row. Please note: This setting is not  supported by '
                    'Internet Explorer 9 and below.'), null=False, blank=False, default=False)
